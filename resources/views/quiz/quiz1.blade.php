                        ...
                        <div class="row control-group">
                            ...
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <div style="text-align: left; color: #1a242f;" class="form-group col-xs-12 form-group controls">
                                   <p style="color: #1a242f;">{{$question->question}}</p>
                                ...
                                <div style="text-align: left; color: #1a242f" class="form-group col-xs-12 form-group controls">
                                    ...
                                    {!! Form::radio('libur', 'Bobok cantik di kamar') !!} Bobok cantik di kamar <br />
                                    <input type="radio" name="libur" value="@{{ Model2 }}" v-model="Model3">Jawaban Lainya
                                    <input style="font-size: 16px" class="form-control" type="text" placeholder="tulis jawaban disini dan kudu jujur ya"  v-show="Model3"/>
                                    --}}{{--<p class="help-block text-danger"></p>--}}{{--
                                </div>--}}
                            </div>
